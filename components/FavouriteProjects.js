...
export default function FavouriteProjects() {
    return (
        <div className="bg-[#F1F1F1] -mt-30 dark:bg-gray-900">
            <div className="max-w-6xl mx-auto">
                <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-10 lg:my-0">
                    <h1 className="text-9xl lg:text-7xl max-w-lg font-bold text-gray-500 my-20 md:my-0 md:text-purple dark:text-gray-600 text-center">
                        Current Work
                    </h1>
                    <Link
                        href="/projects"
